...
//Se n�o encontrar a chave, considera que � um ambiente de Teste
...
Replace ZAL_METODO With c_Verbo         //(Verbo da M�todo)
Replace ZAL_URL    With c_URL           //(URL da API)
Replace ZAL_SERVIC With c_Servic        //(Nome do Servi�o)
Replace ZAL_REQUES With c_Request       //(Request feito)
Replace ZAL_TABERP With c_Tabela        //(Alias da intera��o)
Replace ZAL_CHVERP With c_Chave         //(Chave �nica do Alias)
...
If ( n_RecLog > 0 )
    ...
    Replace ZAL_TABERP With c_Tabela        //(Alias da intera��o)
    Replace ZAL_CHVERP With c_Chave         //(Chave �nica do Alias)
    Replace ZAL_CHVTER With c_ChvTer        //(Chave �nica do Sistema Terceiro)
    MsUnLock()
Endif
