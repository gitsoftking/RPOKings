...
±±³ 27/06/11 ³Compia- Augusto³ Adaptacao para Projeto importa XML         ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function CP01R01(cIdEnt,cVal1,cVal2,oDanfe,oSetup,cFilePrint)
...
User Function CP01R01A(oDanfe,oNFE,cCodAutSef,cModalidade,oNfeDPEC,cCodAutDPEC,cDtHrRecCab,dDtReceb)
...
PRIVATE oFont10N   := TFont():New("Times New Roman",08,08,,.T.,,,,.T.,.F.)// 1
PRIVATE oFont07N   := TFont():New("Times New Roman",06,06,,.T.,,,,.T.,.F.)// 2
PRIVATE oFont07    := TFont():New("Times New Roman",06,06,,.F.,,,,.T.,.F.)// 3
PRIVATE oFont08    := TFont():New("Times New Roman",07,07,,.F.,,,,.T.,.F.)// 4
PRIVATE oFont08N   := TFont():New("Times New Roman",06,06,,.T.,,,,.T.,.F.)// 5
PRIVATE oFont09N   := TFont():New("Times New Roman",08,08,,.T.,,,,.T.,.F.)// 6
PRIVATE oFont09    := TFont():New("Times New Roman",08,08,,.F.,,,,.T.,.F.)// 7
PRIVATE oFont10    := TFont():New("Times New Roman",09,09,,.F.,,,,.T.,.F.)// 8
PRIVATE oFont11    := TFont():New("Times New Roman",10,10,,.F.,,,,.T.,.F.)// 9
PRIVATE oFont12    := TFont():New("Times New Roman",11,11,,.F.,,,,.T.,.F.)// 10
PRIVATE oFont11N   := TFont():New("Times New Roman",10,10,,.T.,,,,.T.,.F.)// 11
PRIVATE oFont18N   := TFont():New("Times New Roman",17,17,,.T.,,,,.T.,.F.)// 12 
PRIVATE OFONT12N   := TFont():New("Times New Roman",11,11,,.T.,,,,.T.,.F.)// 12  
...
oDanfe:Say(006, 002, "RECEBEMOS DE "+NoChar(oEmitente:_xNome:Text,lConverte)+" OS PRODUTOS CONSTANTES DA NOTA FISCAL INDICADA AO LADO", oFont07)
...
oDanfe:Say(017, 510, "N. "+StrZero(Val(oIdent:_NNf:Text),9), oFont08 )
oDanfe:Say(027, 510, "SÉRIE "+oIdent:_Serie:Text, oFont08 )
...
oDanfe:Say(052,098, "Identificação do emitente",oFont12N )
nLinCalc	:=	065
...
Else
	oDanfe:Say(nLinCalc,098, NoChar(oEmitente:_EnderEmit:_xBairro:Text,lConverte)+" Cep:"+TransForm(IIF(Type("oEmitente:_EnderEmit:_Cep")=="U","",oEmitente:_EnderEmit:_Cep:Text),"@r 99999-999"),oFont08N )
	nLinCalc+=10
	oDanfe:Say(nLinCalc,098, oEmitente:_EnderEmit:_xMun:Text+"/"+oEmitente:_EnderEmit:_UF:Text,oFont08N )
	nLinCalc+=10
	oDanfe:Say(nLinCalc,098, "Fone: "+IIf(Type("oEmitente:_EnderEmit:_Fone")=="U","",oEmitente:_EnderEmit:_Fone:Text),oFont08N )
...
oDanfe:Say(055,275, "DANFE",oFont18N )
oDanfe:Say(065,258, "DOCUMENTO AUXILIAR DA",oFont07 )
oDanfe:Say(075,258, "NOTA FISCAL ELETRÔNICA",oFont07 )
oDanfe:Say(085,266, "0-ENTRADA",oFont08 )
oDanfe:Say(095,266, "1-SAÍDA"  ,oFont08 )
oDanfe:Box(078,315,095,325)
oDanfe:Say(089,318, oIdent:_TpNf:Text,oFont08N )
oDanfe:Say(110,255,"N. "+StrZero(Val(oIdent:_NNf:Text),9),oFont10N )
oDanfe:Say(120,255,"SÉRIE "+oIdent:_Serie:Text,oFont10N )
oDanfe:Say(130,255,"FOLHA "+StrZero(nFolha,2)+"/"+StrZero(nFolhas,2),oFont10N )
...
oDanfe:Say(095,355,TransForm(SubStr(oNF:_InfNfe:_ID:Text,4),"@r 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999"),oFont12N )
oDanfe:Box(105,350,137,603)

If nFolha == 1
	oDanfe:Say(085,355,"CHAVE DE ACESSO DA NF-E",oFont12N )
	nFontSize := 28
...
If Empty(cCodAutDPEC)
	If Empty(cChaveCont)
		oDanfe:Say(117,355,"Consulta de autenticidade no portal nacional da NF-e",oFont12 )
		oDanfe:Say(127,355,"www.nfe.fazenda.gov.br/portal ou no site da SEFAZ Autorizada",oFont12 )
	Endif
Endif
...
oDanfe:Say(148,002,"NATUREZA DA OPERAÇÃO",oFont08N )
oDanfe:Say(158,002,oIdent:_NATOP:TEXT,oFont08 )


If !Empty(cCodAutDPEC)
	oDanfe:Say(148,350,"NÚMERO DE REGISTRO DPEC",oFont08N )
Endif
...
oDanfe:Say(172,002,"INSCRIÇÃO ESTADUAL",oFont08N )
oDanfe:Say(180,002,IIf(Type("oEmitente:_IE:TEXT")<>"U",oEmitente:_IE:TEXT,""),oFont08 )
oDanfe:Say(172,205,"INSC.ESTADUAL DO SUBST.TRIB.",oFont08N )
oDanfe:Say(180,205,IIf(Type("oEmitente:_IEST:TEXT")<>"U",oEmitente:_IEST:TEXT,""),oFont08 )
oDanfe:Say(172,405,"CNPJ",oFont08N )
oDanfe:Say(180,405,TransForm(oEmitente:_CNPJ:TEXT,IIf(Len(oEmitente:_CNPJ:TEXT)<>14,"@r 999.999.999-99","@r 99.999.999/9999-99")),oFont08 )
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
...
oDanfe:Say(195,002,"DESTINATARIO/REMETENTE",oFont08N )
oDanfe:Box(197,000,217,450)
oDanfe:Say(205,002, "NOME/RAZÃO SOCIAL",oFont08N )
oDanfe:Say(215,002,NoChar(oDestino:_XNome:TEXT,lConverte),oFont08 )
oDanfe:Box(197,280,217,500)
oDanfe:Say(205,283,"CNPJ/CPF",oFont08N )
oDanfe:Say(215,283,cAux,oFont08 )

oDanfe:Box(217,000,237,500)
oDanfe:Box(217,000,237,260)
oDanfe:Say(224,002,"ENDEREÇO",oFont08N )
oDanfe:Say(234,002,aDest[01],oFont08 )
oDanfe:Box(217,230,237,380)
oDanfe:Say(224,232,"BAIRRO/DISTRITO",oFont08N )
oDanfe:Say(234,232,aDest[02],oFont08 )
oDanfe:Box(217,380,237,500)
oDanfe:Say(224,382,"CEP",oFont08N )
oDanfe:Say(234,382,aDest[03],oFont08 )

oDanfe:Box(236,000,257,500)
oDanfe:Box(236,000,257,180)
oDanfe:Say(245,002,"MUNICIPIO",oFont08N )
oDanfe:Say(255,002,aDest[05],oFont08 )
oDanfe:Box(236,150,257,256)
oDanfe:Say(245,152,"FONE/FAX",oFont08N )
oDanfe:Say(255,152,aDest[06],oFont08 )
oDanfe:Box(236,255,257,341)
oDanfe:Say(245,257,"UF",oFont08N )
oDanfe:Say(255,257,aDest[07],oFont08 )
oDanfe:Box(236,340,257,500)
oDanfe:Say(245,342,"INSCRIÇÃO ESTADUAL",oFont08N )
oDanfe:Say(255,342,aDest[08],oFont08 )


oDanfe:Box(197,502,217,603)
oDanfe:Say(205,504,"DATA DE EMISSÃO",oFont08N )
oDanfe:Say(215,504,ConvDate(oIdent:_DEmi:TEXT),oFont08 )
oDanfe:Box(217,502,237,603)
oDanfe:Say(224,504,"DATA ENTRADA/SAÍDA",oFont08N )
oDanfe:Say(233,504,Iif( Empty(aDest[4]),"",ConvDate(aDest[4]) ),oFont08 )
oDanfe:Box(236,502,257,603)
oDanfe:Say(243,503,"HORA ENTRADA/SAÍDA",oFont08N )
oDanfe:Say(252,503,aHrEnt[01],oFont08 )
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³Quadro fatura                                                           ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
aAux := {{{},{},{},{},{},{},{},{},{}}}
...
If Len(aFaturas) >0
	For nY := 1 To 9
		oDanfe:Say(273,nColuna,aAux[1][nY][1],oFont08 )
		oDanfe:Say(281,nColuna,aAux[1][nY][2],oFont08 )
		oDanfe:Say(289,nColuna,aAux[1][nY][3],oFont08 )
		nColuna:= nColuna+67
	Next nY
Endif
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³Calculo do imposto                                                      ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oDanfe:Say(305,002,"CALCULO DO IMPOSTO",oFont08N )
oDanfe:Box(307,000,330,121)
oDanfe:Say(316,002,"BASE DE CALCULO DO ICMS",oFont08N )
If cMVCODREG$"3"
	oDanfe:Say(326,002,aTotais[01],oFont08 )
Endif
oDanfe:Box(307,120,330,200)
oDanfe:Say(316,125,"VALOR DO ICMS",oFont08N )
If cMVCODREG$"3"
	oDanfe:Say(326,125,aTotais[02],oFont08 )
Endif
oDanfe:Box(307,199,330,360)
oDanfe:Say(316,200,"BASE DE CALCULO DO ICMS SUBSTITUIÇÃO",oFont08N )
oDanfe:Say(326,202,aTotais[03],oFont08 )
oDanfe:Box(307,360,330,490)
oDanfe:Say(316,363,"VALOR DO ICMS SUBSTITUIÇÃO",oFont08N )
oDanfe:Say(326,363,aTotais[04],oFont08 )
oDanfe:Box(307,490,330,603)
oDanfe:Say(316,491,"VALOR TOTAL DOS PRODUTOS",oFont08N )
oDanfe:Say(327,491,aTotais[05],oFont08 )


oDanfe:Box(330,000,353,110)
oDanfe:Say(339,002,"VALOR DO FRETE",oFont08N )
oDanfe:Say(349,002,aTotais[06],oFont08 )
oDanfe:Box(330,100,353,190)
oDanfe:Say(339,102,"VALOR DO SEGURO",oFont08N )
oDanfe:Say(349,102,aTotais[07],oFont08 )
oDanfe:Box(330,190,353,290)
oDanfe:Say(339,194,"DESCONTO",oFont08N )
oDanfe:Say(349,194,aTotais[08],oFont08 )
oDanfe:Box(330,290,353,415)
oDanfe:Say(339,295,"OUTRAS DESPESAS ACESSÓRIAS",oFont08N )
oDanfe:Say(349,295,aTotais[09],oFont08 )
oDanfe:Box(330,414,353,500)
oDanfe:Say(339,420,"VALOR DO IPI",oFont08N )
oDanfe:Say(349,420,aTotais[10],oFont08 )
oDanfe:Box(330,500,353,603)
oDanfe:Say(339,506,"VALOR TOTAL DA NOTA",oFont08N )
oDanfe:Say(349,506,aTotais[11],oFont08 )
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³Transportador/Volumes transportados                                     ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oDanfe:Say(361,002,"TRANSPORTADOR/VOLUMES TRANSPORTADOS",oFont08N )
oDanfe:Box(363,000,386,603)
oDanfe:Say(372,002,"RAZÃO SOCIAL",oFont08N )
oDanfe:Say(382,002,aTransp[01],oFont08 )
oDanfe:Box(363,245,386,315)
oDanfe:Say(372,247,"FRETE POR CONTA",oFont08N )
If cModFrete =="0"
	oDanfe:Say(382,247,"0-EMITENTE",oFont08 )
ElseIf cModFrete =="1"
	oDanfe:Say(382,247,"1-DEST/REM",oFont08 )
ElseIf cModFrete =="2"
...
Endif
//oDanfe:Say(382,102,"0-EMITENTE/1-DESTINATARIO       [" + aTransp[02] + "]",oFont08 )
oDanfe:Box(363,315,386,370)
oDanfe:Say(372,317,"CÓDIGO ANTT",oFont08N )
oDanfe:Say(382,319,aTransp[03],oFont08 )
oDanfe:Box(363,370,386,490)
oDanfe:Say(372,375,"PLACA DO VEÍCULO",oFont08N )
oDanfe:Say(382,375,aTransp[04],oFont08 )
oDanfe:Box(363,450,386,510)
oDanfe:Say(372,452,"UF",oFont08N )
oDanfe:Say(382,452,aTransp[05],oFont08 )
oDanfe:Box(363,510,386,603)
oDanfe:Say(372,512,"CNPJ/CPF",oFont08N )
oDanfe:Say(382,512,aTransp[06],oFont08 )

oDanfe:Box(385,000,409,603)
oDanfe:Box(385,000,409,241)
oDanfe:Say(393,002,"ENDEREÇO",oFont08N )
oDanfe:Say(404,002,aTransp[07],oFont08 )
oDanfe:Box(385,240,409,341)
oDanfe:Say(393,242,"MUNICIPIO",oFont08N )
oDanfe:Say(404,242,aTransp[08],oFont08 )
oDanfe:Box(385,340,409,440)
oDanfe:Say(393,342,"UF",oFont08N )
oDanfe:Say(404,342,aTransp[09],oFont08 )
oDanfe:Box(385,440,409,603)
oDanfe:Say(393,442,"INSCRIÇÃO ESTADUAL",oFont08N )
oDanfe:Say(404,442,aTransp[10],oFont08 )


oDanfe:Box(408,000,432,603)
oDanfe:Box(408,000,432,101)
oDanfe:Say(418,002,"QUANTIDADE",oFont08N )
oDanfe:Say(428,002,aTransp[11],oFont08 )
oDanfe:Box(408,100,432,200)
oDanfe:Say(418,102,"ESPECIE",oFont08N )
oDanfe:Say(428,102,Iif(!Empty(aTransp[12]),aTransp[12],Iif(Len(aEspVol)>0,aEspVol[1][1],"")),oFont08 )
//oDanfe:Say(428,102,aEspVol[1][1],oFont08 )
oDanfe:Box(408,200,432,301)
oDanfe:Say(418,202,"MARCA",oFont08N )
oDanfe:Say(428,202,aTransp[13],oFont08 )
oDanfe:Box(408,300,432,400)
oDanfe:Say(418,302,"NUMERAÇÃO",oFont08N )
oDanfe:Say(428,302,aTransp[14],oFont08 )
oDanfe:Box(408,400,432,501)
oDanfe:Say(418,402,"PESO BRUTO",oFont08N )
oDanfe:Say(428,402,Iif(!Empty(aTransp[15]),aTransp[15],Iif(Len(aEspVol)>0 .And. Val(aEspVol[1][3])>0,Transform(Val(aEspVol[1][3]),"@E 999999.9999"),"")),oFont08 )
//oDanfe:Say(428,402,Iif (!Empty(aEspVol[1][3]),Transform(val(aEspVol[1][3]),"@E 999999.9999"),""),oFont08 )
oDanfe:Box(408,500,432,603)
oDanfe:Say(418,502,"PESO LIQUIDO",oFont08N )
oDanfe:Say(428,502,Iif(!Empty(aTransp[16]),aTransp[16],Iif(Len(aEspVol)>0 .And. Val(aEspVol[1][2])>0,Transform(Val(aEspVol[1][2]),"@E 999999.9999"),"")),oFont08 )
//oDanfe:Say(428,502,Iif (!Empty(aEspVol[1][2]),Transform(val(aEspVol[1][2]),"@E 999999.9999"),""),oFont08 )
...
For nX := 1 To Min(nLenMensagens, MAXMSG)
	oDanfe:Say(nLin,002,aMensagem[nX],oFont08 )
	nLin:= nLin+10
Next nX
nMensagem := nX
...
oDanfe:Say(440,002,"DADOS DO PRODUTO / SERVIÇO",oFont08N )
oDanfe:Box(442,000,678,603)
oDanfe:Box(442,000,678,052)
oDanfe:Say(450,002,"COD. PROD",oFont08N )
oDanfe:Box(442,052,678,155)
oDanfe:Say(450,054,"DESCRIÇÃO DO PROD./SERV.",oFont08N )
oDanfe:Box(442,155,678,190)
oDanfe:Say(450,157,"NCM/SH",oFont08N )
oDanfe:Box(442,190,678,210)
oDanfe:Say(450,192,"CST",oFont08N )
oDanfe:Box(442,210,678,230)
oDanfe:Say(450,212,"CFOP",oFont08N )
oDanfe:Box(442,230,678,250)
oDanfe:Say(450,232,"UN",oFont08N )
oDanfe:Box(442,250,678,289)
oDanfe:Say(450,252,"QUANT.",oFont08N )
oDanfe:Box(442,289,678,346)
oDanfe:Say(450,292,"V.UNITARIO",oFont08N )
oDanfe:Box(442,346,678,400)
oDanfe:Say(450,352,"V.TOTAL",oFont08N )
oDanfe:Box(442,400,678,465)
oDanfe:Say(450,402,"BC.ICMS",oFont08N )
oDanfe:Box(442,465,678,515)
oDanfe:Say(450,467,"V.ICMS",oFont08N )
oDanfe:Box(442,515,678,550)
oDanfe:Say(450,517,"V.IPI",oFont08N )
oDanfe:Box(442,550,678,578)
oDanfe:Say(450,552,"A.ICMS",oFont08N )
oDanfe:Box(442,578,678,603)
oDanfe:Say(450,582,"A.IPI",oFont08N )
...
For nY := 1 To nLenItens
	...
	If lflag
		If nL > nMaxItemP2
			...
			oDanfe:Say(010+nLinhavers,098, "Identificação do emitente",oFont12N )
			...
			oDanfe:Say(013+nLinhavers,255, "DANFE",oFont18N )
			oDanfe:Say(023+nLinhavers,255, "DOCUMENTO AUXILIAR DA",oFont07 )
			oDanfe:Say(033+nLinhavers,255, "NOTA FISCAL ELETRÔNICA",oFont07 )
			oDanfe:Say(043+nLinhavers,255, "0-ENTRADA",oFont08 )
			oDanfe:Say(053+nLinhavers,255, "1-SAÍDA"  ,oFont08 )
			oDanfe:Box(037+nLinhavers,305,047+nLinhavers,315)
			oDanfe:Say(045+nLinhavers,307, oIdent:_TpNf:Text,oFont08N )
			oDanfe:Say(062+nLinhavers,255,"N. "+StrZero(Val(oIdent:_NNf:Text),9),oFont10N )
			oDanfe:Say(072+nLinhavers,255,"SÉRIE "+oIdent:_Serie:Text,oFont10N )
			oDanfe:Say(082+nLinhavers,255,"FOLHA "+StrZero(nFolha,2)+"/"+StrZero(nFolhas,2),oFont10N )
			...
			oDanfe:Say(058+nLinhavers,355,TransForm(SubStr(oNF:_InfNfe:_ID:Text,4),"@r 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999"),oFont12N )
			
			oDanfe:Say(048+nLinhavers,355,"CHAVE DE ACESSO DA NF-E",oFont12N )
			nFontSize := 28
			...
			If Empty(cChaveCont)
				oDanfe:Say(075+nLinhavers,355,"Consulta de autenticidade no portal nacional da NF-e",oFont12 )
				oDanfe:Say(085+nLinhavers,355,"www.nfe.fazenda.gov.br/portal ou no site da SEFAZ Autorizada",oFont12 )
			Endif
			...
			oDanfe:Say(109+nLinhavers,002,"NATUREZA DA OPERAÇÃO",oFont08N )
			oDanfe:Say(119+nLinhavers,002,oIdent:_NATOP:TEXT,oFont08 )
			If(!Empty(cCodAutDPEC))
				oDanfe:Say(109+nLinhavers,300,"NÚMERO DE REGISTRO DPEC",oFont08N )
			Endif
			If(((Val(oNF:_INFNFE:_IDE:_SERIE:TEXT) >= 900).And.(oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"2") .Or. (oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"1")
				oDanfe:Say(109+nLinhavers,302,"PROTOCOLO DE AUTORIZAÇÃO DE USO",oFont08N )
			Endif
			If((oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"25")
				oDanfe:Say(109+nLinhavers,300,"DADOS DA NF-E",oFont08N )
			Endif
			...
			oDanfe:Say(135+nLinhavers,002,"INSCRIÇÃO ESTADUAL",oFont08N )
			oDanfe:Say(143+nLinhavers,002,IIf(Type("oEmitente:_IE:TEXT")<>"U",oEmitente:_IE:TEXT,""),oFont08 )
			oDanfe:Say(135+nLinhavers,205,"INSC.ESTADUAL DO SUBST.TRIB.",oFont08N )
			oDanfe:Say(143+nLinhavers,205,IIf(Type("oEmitente:_IEST:TEXT")<>"U",oEmitente:_IEST:TEXT,""),oFont08 )
			oDanfe:Say(135+nLinhavers,405,"CNPJ",oFont08N )
			oDanfe:Say(143+nLinhavers,405,TransForm(oEmitente:_CNPJ:TEXT,IIf(Len(oEmitente:_CNPJ:TEXT)<>14,"@r 999.999.999-99","@r 99.999.999/9999-99")),oFont08 )
			
			nLenMensagens:= Len(aMensagem)
			
			nColLim		:=	Iif(MV_PAR05==1,435,Iif(nMensagem < nLenMensagens,680,865)) + nLinhavers 
			oDanfe:Say(161+nLinhavers,002,"DADOS DO PRODUTO / SERVIÇO",oFont08N )
			oDanfe:Box(163+nLinhavers,000,nColLim,603)
			
			oDanfe:Box(163+nLinhavers,000,nColLim,052)
			oDanfe:Say(171+nLinhavers,002,"COD. PROD",oFont08N )
			
			oDanfe:Box(163+nLinhavers,052,nColLim,155)
			oDanfe:Say(171+nLinhavers,054,"DESCRIÇÃO DO PROD./SER.",oFont08N )
			
			oDanfe:Box(163+nLinhavers,155,nColLim,190)
			oDanfe:Say(171+nLinhavers,157,"NCM/SH",oFont08N )
			
			oDanfe:Box(163+nLinhavers,190,nColLim,210)
			oDanfe:Say(171+nLinhavers,192,"CST",oFont08N )
			
			oDanfe:Box(163+nLinhavers,210,nColLim,230)
			oDanfe:Say(171+nLinhavers,212,"CFOP",oFont08N )
			
			oDanfe:Box(163+nLinhavers,230,nColLim,250)
			oDanfe:Say(171+nLinhavers,232,"UN",oFont08N )
			
			oDanfe:Box(163+nLinhavers,250,nColLim,289)
			oDanfe:Say(171+nLinhavers,252,"QUANT.",oFont08N )
			
			oDanfe:Box(163+nLinhavers,289,nColLim,346)
			oDanfe:Say(171+nLinhavers,292,"V.UNITARIO",oFont08N )
			
			oDanfe:Box(163+nLinhavers,346,nColLim,400)
			oDanfe:Say(171+nLinhavers,348,"V.TOTAL",oFont08N )
			
			oDanfe:Box(163+nLinhavers,400,nColLim,465)
			oDanfe:Say(171+nLinhavers,402,"BC.ICMS",oFont08N )
			
			oDanfe:Box(163+nLinhavers,465,nColLim,515)
			oDanfe:Say(171+nLinhavers,467,"V.ICMS",oFont08N )
			
			oDanfe:Box(163+nLinhavers,515,nColLim,550)
			oDanfe:Say(171+nLinhavers,517,"V.IPI",oFont08N )
			
			oDanfe:Box(163+nLinhavers,550,nColLim,578)
			oDanfe:Say(171+nLinhavers,552,"A.ICMS",oFont08N )
			
			oDanfe:Box(163+nLinhavers,578,nColLim,603)
			oDanfe:Say(171+nLinhavers,582,"A.IPI",oFont08N )
	...
	If	nL > Iif( (nfolha-1)%2==0 .And. MV_PAR05==1,MAXITEMP3,nMaxItemP2)
		...
		oDanfe:Say(010,098, "Identificação do emitente",oFont12N )
		nLinCalc	:=	023
		cStrAux		:=	AllTrim(NoChar(oEmitente:_xNome:Text,lConverte))
		nForTo		:=	Len(cStrAux)/25
		nForTo		+=	Iif(nForTo>Round(nForTo,0),Round(nForTo,0)+1-nForTo,nForTo)
		...
		oDanfe:Say(013,255, "DANFE",oFont18N )
		oDanfe:Say(023,255, "DOCUMENTO AUXILIAR DA",oFont07 )
		oDanfe:Say(033,255, "NOTA FISCAL ELETRÔNICA",oFont07 )
		oDanfe:Say(043,255, "0-ENTRADA",oFont08 )
		oDanfe:Say(053,255, "1-SAÍDA"  ,oFont08 )
		oDanfe:Box(037,305,047,315)
		oDanfe:Say(045,307, oIdent:_TpNf:Text,oFont08N )
		oDanfe:Say(062,255,"N. "+StrZero(Val(oIdent:_NNf:Text),9),oFont10N )
		oDanfe:Say(072,255,"SÉRIE "+oIdent:_Serie:Text,oFont10N )
		oDanfe:Say(082,255,"FOLHA "+StrZero(nFolha,2)+"/"+StrZero(nFolhas,2),oFont10N )
		
		oDanfe:Box(000,350,095,603)
		oDanfe:Box(000,350,040,603)
		oDanfe:Box(040,350,062,603)
		oDanfe:Box(063,350,095,603)
		oDanfe:Say(058,355,TransForm(SubStr(oNF:_InfNfe:_ID:Text,4),"@r 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999"),oFont12N )
		
		oDanfe:Say(048,355,"CHAVE DE ACESSO DA NF-E",oFont12N )
		nFontSize := 28
		...
		If Empty(cChaveCont)
			oDanfe:Say(075,355,"Consulta de autenticidade no portal nacional da NF-e",oFont12 )
			oDanfe:Say(085,355,"www.nfe.fazenda.gov.br/portal ou no site da SEFAZ Autorizada",oFont12 )
		Endif
		...
		oDanfe:Say(109,002,"NATUREZA DA OPERAÇÃO",oFont08N )
		oDanfe:Say(119,002,oIdent:_NATOP:TEXT,oFont08 )
		If(!Empty(cCodAutDPEC))
			oDanfe:Say(109,300,"NÚMERO DE REGISTRO DPEC",oFont08N )
		Endif
		If(((Val(oNF:_INFNFE:_IDE:_SERIE:TEXT) >= 900).And.(oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"2") .Or. (oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"1")
			oDanfe:Say(109,302,"PROTOCOLO DE AUTORIZAÇÃO DE USO",oFont08N )
		Endif
		If((oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"25")
			oDanfe:Say(109,300,"DADOS DA NF-E",oFont08N )
		Endif
		...
		oDanfe:Say(135,002,"INSCRIÇÃO ESTADUAL",oFont08N )
		oDanfe:Say(143,002,IIf(Type("oEmitente:_IE:TEXT")<>"U",oEmitente:_IE:TEXT,""),oFont08 )
		oDanfe:Say(135,205,"INSC.ESTADUAL DO SUBST.TRIB.",oFont08N )
		oDanfe:Say(143,205,IIf(Type("oEmitente:_IEST:TEXT")<>"U",oEmitente:_IEST:TEXT,""),oFont08 )
		oDanfe:Say(135,405,"CNPJ",oFont08N )
		oDanfe:Say(143,405,TransForm(oEmitente:_CNPJ:TEXT,IIf(Len(oEmitente:_CNPJ:TEXT)<>14,"@r 999.999.999-99","@r 99.999.999/9999-99")),oFont08 )
		
		oDanfe:Say(161,002,"DADOS DO PRODUTO / SERVIÇO",oFont08N )
		oDanfe:Box(163,000,nColLim,603)
		/*
		oDanfe:Box(163,000,nColLim,061)
		oDanfe:Say(171,002,"COD. PROD",oFont08N )
		oDanfe:Box(163,060,nColLim,170)
		oDanfe:Say(171,062,"DESCRIÇÃO DO PROD./SER.",oFont10N )
		oDanfe:Box(163,165,nColLim,211)
		oDanfe:Say(171,167,"NCM/SH",oFont08N )
		oDanfe:Box(163,210,nColLim,230)
		oDanfe:Say(171,212,"CST",oFont08N )
		oDanfe:Box(163,230,nColLim,260)
		oDanfe:Say(171,232,"CFOP",oFont08N )
		oDanfe:Box(163,260,nColLim,280)
		oDanfe:Say(171,262,"UN",oFont08N )
		oDanfe:Box(163,280,nColLim,320)
		oDanfe:Say(171,282,"QUANT.",oFont08N )
		oDanfe:Box(163,320,nColLim,375)
		oDanfe:Say(171,322,"V.UNITARIO",oFont08N )
		oDanfe:Box(163,375,nColLim,425)
		oDanfe:Say(171,377,"V.TOTAL",oFont08N )
		oDanfe:Box(163,425,nColLim,475)
		oDanfe:Say(171,427,"BC.ICMS",oFont08N )
		oDanfe:Box(163,475,nColLim,515)
		oDanfe:Say(171,477,"V.ICMS",oFont08N )
		oDanfe:Box(163,515,nColLim,550)
		oDanfe:Say(171,517,"V.IPI",oFont08N )
		oDanfe:Box(163,550,nColLim,580)
		oDanfe:Say(171,552,"A.ICMS",oFont08N )
		oDanfe:Box(163,580,nColLim,603)
		oDanfe:Say(171,582,"A.IPI",oFont08N )
		*/
		
		oDanfe:Box(163,000,nColLim,052)
		oDanfe:Say(171,002,"COD. PROD",oFont08N )
		oDanfe:Box(163,052,nColLim,155)
		oDanfe:Say(171,054,"DESCRIÇÃO DO PROD./SER.",oFont08N )
		oDanfe:Box(163,155,nColLim,190)
		oDanfe:Say(171,157,"NCM/SH",oFont08N )
		oDanfe:Box(163,190,nColLim,210)
		oDanfe:Say(171,192,"CST",oFont08N )
		oDanfe:Box(163,210,nColLim,230)
		oDanfe:Say(171,212,"CFOP",oFont08N )
		oDanfe:Box(163,230,nColLim,250)
		oDanfe:Say(171,232,"UN",oFont08N )
		oDanfe:Box(163,250,nColLim,289)
		oDanfe:Say(171,252,"QUANT.",oFont08N )
		oDanfe:Box(163,289,nColLim,346)
		oDanfe:Say(171,292,"V.UNITARIO",oFont08N )
		oDanfe:Box(163,346,nColLim,400)
		oDanfe:Say(171,348,"V.TOTAL",oFont08N )
		oDanfe:Box(163,400,nColLim,465)
		oDanfe:Say(171,402,"BC.ICMS",oFont08N )
		oDanfe:Box(163,465,nColLim,515)
		oDanfe:Say(171,467,"V.ICMS",oFont08N )
		oDanfe:Box(163,515,nColLim,550)
		oDanfe:Say(171,517,"V.IPI",oFont08N )
	...
	oDanfe:SayAlign(nLinha-5,243,aAux[1][7][nY],oFont08 ,45, 10, , 1,  )//QUANT
	oDanfe:SayAlign(nLinha-5,293,aAux[1][8][nY],oFont08 ,52, 10, , 1,  )//V UNITARIO
	oDanfe:SayAlign(nLinha-5,348,aAux[1][9][nY],oFont08 ,50, 10, , 1,  )//V. TOTAL
	oDanfe:SayAlign(nLinha-5,412,aAux[1][10][nY],oFont08 ,50, 10, , 1,  )//BC. ICMS
	oDanfe:SayAlign(nLinha-5,467,aAux[1][11][nY],oFont08 ,45, 10, , 1,  )//V. ICMS
	oDanfe:SayAlign(nLinha-5,504,aAux[1][12][nY],oFont08 ,45, 10, , 1,  )//V.IPI
	oDanfe:SayAlign(nLinha-5,546,aAux[1][13][nY],oFont08 ,30, 10, , 1,  )//A.ICMS
	oDanfe:SayAlign(nLinha-5,566,aAux[1][14][nY],oFont08 ,36, 10, , 1,  )//A.IPI
...
If lMensagens
	...
	oDanfe:StartPage()
	nLinha    :=180
	oDanfe:Say(160,000,"DADOS ADICIONAIS",oFont08N )
	oDanfe:Box(172,000,865,351)
	oDanfe:Say(170,002,"INFORMAÇÕES COMPLEMENTARES",oFont08N )
	oDanfe:Box(172,350,865,603)
	oDanfe:Say(170,352,"RESERVADO AO FISCO",oFont08N )
